...
import { THEME_KEY } from './theme-early.js';
...
// ---------- theme ----------
// THEME_KEY comes from src/theme-early.js, whose block every page carries in its <head> and runs before
// the page is first styled. So by the time this module evaluates, the value resolved below is already on
// <html>; applying it again changes no style and is what dispatches `tb-theme-change`.
