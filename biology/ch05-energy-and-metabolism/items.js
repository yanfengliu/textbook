...
export const ITEMS = [
...

  {
    ...
    options: [
      { text: 'Potential energy, held in the arrangement of the atoms and the electrons — the same kind as a weight on a shelf, and released when that arrangement changes to a more stable one.', correct: true },
      { text: 'Kinetic energy, because the atoms in a molecule are vibrating and rotating all the time.',
      ...
      { text: 'Potential energy, held in the bonds, so that breaking the bonds lets it out.',
  ...
  },
  {
    ...
    options: [
      { text: 'The tea. Heat is the random motion of molecules, so a hot cup is a cup whose molecules are moving faster than a cold one\'s.', correct: true },
      { text: 'The petrol, because it is a liquid and its molecules are free to move about.',
      ...
      { text: 'The spring, because the energy will come out as movement the moment it is let go.',
      ...
      { text: 'The gradient, because the ions are diffusing across the membrane the whole time.',
...

  {
    ...
    options: [
      ...
      { text: 'Nothing is wrong with it, except that chloroplasts produce energy too.',
      ...
      { text: 'It is wrong because mitochondria store energy rather than producing it.',
  ...
  },
  {
    ...
    objective: 'first-law',
    kind: 'mcq',
    question: 'An adult takes in about 8400 kilojoules a day and their weight does not change. Where do the 8400 kilojoules go?',
    options: [
      { text: 'All 8400 leave again, and almost all of it as heat — which works out at a little under 100 joules a second, so a person is roughly a hundred-watt heater.', correct: true },
      { text: 'Most of it is used up doing the body\'s work, and what is left over leaves as heat.',
      ...
      { text: 'Most is stored, and a steady weight means the store is large enough not to change measurably.',
      ...
      { text: 'Most of it goes into building and maintaining the body\'s order, which is why it does not come out again.',
    ...
    explain: '2000 kilocalories is about 8400 kilojoules; divide by the 86 400 seconds in a day and you get a little under 100 joules a second. It is why a full lecture theatre grows warm and why the arithmetic of a spacecraft has to include the people in it. Every step a cell takes is a little inefficient, and the inefficiency leaves as random molecular motion which spreads out and does not come back.',
  },
  {
    id: 'i-first-law-3',
    objective: 'first-law',
  ...
  },
  {
    ...
    options: [
      { text: 'There is one arrangement that counts as factory order and an unimaginable number that count as untidy, so overwhelmingly more of the arrangements a shuffle can reach are untidy ones.', correct: true },
      { text: 'Nature prefers disorder, and the shuffle lets that preference act.',
      ...
      { text: 'The ordered arrangement is forbidden once the deck has been shuffled, because entropy cannot decrease.',
      ...
      { text: 'Shuffling adds energy to the deck, and energy always disorders things.',
  ...
  },
  {
    ...
    options: [
      { text: 'It goes on growing for a while, lowering its own entropy by raising the ampoule\'s more; when the broth is spent and the waste has built up it stops, and then it comes apart. The total rises throughout.', correct: true },
      { text: 'It stops growing at once, because a sealed system cannot lower its entropy anywhere inside it.',
      ...
      { text: 'It goes on growing indefinitely, since the ampoule holds its own food and the second law does not act on living things.',
      ...
      { text: 'It stops growing when the energy in the broth has been destroyed by being used.',
  ...
  },
  {
    ...
    options: [
      { text: 'The label turns up in the product, and label in the product turns up back in the reactant, at equal rates — so the amounts of each never change although both conversions are happening the whole time.', correct: true },
      { text: 'Nothing. At ΔG = 0 the reaction has stopped, so the label stays where it was put.',
      ...
      { text: 'The label turns up in the product and stays there, because the forward reaction is the one that happened.',
      ...
      { text: 'Nothing changes, because ΔG = 0 means the reaction gives out no heat and so nothing drives it.',
  ...
  },
  {
    ...
    options: [
      { text: 'The entropy term wins. A solid crystal becoming ions dispersed through a liquid is a very large increase in the arrangements available, and TΔS outweighs the positive ΔH.', correct: true },
      { text: 'ΔH must really be negative; the beaker feels cold for some other reason.',
      ...
      { text: 'The dissolving is catalysed by the water, and a catalyst can make an endergonic process go.',
      ...
      { text: 'It is driven by the water\'s own energy, which is released as the crystal breaks up.',
...

  {
    ...
    kind: 'mcq',
    question: 'A spoonful of sugar sits in a bowl in the air for a year and is still sugar. Glucose and oxygen together have a ΔG of about −2870 kilojoules per mole. Which statement is right?',
    options: [
      { text: 'The reaction is strongly exergonic and therefore permitted; what stops it is the activation energy, and thermodynamics says nothing about how fast.', correct: true },
      { text: 'ΔG must be positive at room temperature, and only becomes negative when the sugar is heated.',
      ...
      { text: 'Sugar and oxygen simply do not react with each other under any conditions.',
        why: 'Denies the reaction rather than its rate. Set light to the sugar and it burns to carbon dioxide and water, releasing every one of those 2870 kilojoules — and your own cells do the same reaction at 37 °C.' },
      { text: 'The reaction needs a catalyst, and a reaction that needs a catalyst is endergonic until it gets one.',
  ...
  },
  {
    ...
    options: [
      { text: 'The decomposition is strongly permitted and has a barrier high enough that almost nothing gets over it at room temperature. The shelf life is a fact about the rate and says nothing about ΔG.', correct: true },
      { text: 'The coating must be holding the tablet away from equilibrium, the way a cell holds its ATP.',
      ...
      { text: 'ΔG must be near zero inside a dry tablet, since there is little water for the reaction.',
      ...
      { text: 'Adding a catalyst would make the reaction less favourable and preserve the tablets longer.',
  ...
  },
  {
    ...
    rubric: [
      ...
      'sugar in a bowl is exergonic by about 2870 kilojoules a mole and lasts for years; diamond is unstable with respect to graphite and does not turn grey',
  ...
  },
  {
    ...
    options: [
      { text: 'The next enzyme takes its product away before it can build up, so the actual ratio of product to reactant stays low enough to keep the true ΔG negative — and at 5.9 kilojoules per mole per tenfold ratio, a little over one decade is enough.', correct: true },
      { text: 'Its enzyme makes the reaction exergonic, which is what an enzyme is for.',
      ...
      { text: 'ATP is hydrolysed nearby and the heat released pushes the step over.',
      ...
      { text: 'The tabulated +7 must be wrong, since a reaction that runs cannot have a positive value.',
    ...
    explain: 'This is why metabolism is arranged in pathways. A step whose standard value is slightly positive runs perfectly well in the middle of a sequence, because the step after it removes the product. A pathway is not a queue of separate reactions; it is one reaction pulling the next.',
  },
  {
  ...
  },
  {
    ...
    options: [
      { text: 'The flame is a steady state: its composition holds still because matter is flowing through it at a constant rate, and it goes out when the wax runs out. The flask is at equilibrium: nothing is flowing, ΔG is zero, and there is no work left in it.', correct: true },
      { text: 'There is no real difference: a steady state is an equilibrium that is being reached slowly.',
      ...
      { text: 'The flame has a positive ΔG maintained by the heat, and the flask has a negative one.',
  ...
  },
  {
    ...
    options: [
      { text: 'Adenine joined to ribose, with a chain of three phosphate groups attached to the sugar — a nucleotide with two extra phosphates.', correct: true },
      { text: 'Adenine joined to deoxyribose, with three phosphate groups.',
      ...
      { text: 'Adenine with three phosphate groups attached directly to the base, and a ribose on the other side.',
      ...
      { text: 'A small protein with three phosphate groups bound to it.',
  ...
  },
  {
    ...
    options: [
      { text: 'It falls, because one of the four things that paid for the reaction — the relief of the crowded charges — has been removed. The other three still apply, so it does not fall to nothing.', correct: true },
      { text: 'Nothing changes, because the bond being broken is the same bond.',
      ...
      { text: 'It rises, because pulling the phosphates apart has strained the molecule and strain is stored energy.',
      ...
      { text: 'It falls to zero, since electrostatic repulsion is what makes ATP an energy carrier.',
  ...
  },
  {
    ...
    options: [
      { text: 'Breaking a covalent bond always costs energy — Section 2.2 puts a carbon–carbon bond at about 350 kilojoules per mole — so nothing is ever obtained by breaking one on its own. The 30.5 is a balance over everything that changes.', correct: true },
      { text: 'The bond joining one phosphate to the next is weaker than other covalent bonds, so less energy is needed to break it.',
      ...
      { text: 'The squiggle used to draw the bond is only a notation, and a notation cannot store energy.',
      ...
      { text: 'The energy is stored in the whole molecule rather than in any one bond.',
    ...
    explain: 'A reaction releases free energy when the bonds made in the products, taken together with everything else that changes, are better than the bonds broken in the reactants. The energy comes out of the comparison, not out of a bond. Some textbooks now use "phosphoryl transfer potential" instead — a measure of how readily a compound will hand its phosphate to something else — which puts the emphasis on the transfer and on what is waiting at the other end.',
  },
  {
...

  {
    ...
    kind: 'task',
    figure: 'fig-atp',
    goal: 'Push all three concentration sliders — ATP, ADP and Pᵢ — up to 1000 millimoles per litre, which is one mole per litre each. Then compare the ΔG the figure prints with the ledger total above it.',
  ...
  },
  {
    ...
    options: [
      { text: 'About −50 kilojoules per mole. The ratio of products to reactants is 5 × 10<sup>−4</sup>, whose logarithm multiplied by RT is −19.6, and −30.5 − 19.6 is about −50.', correct: true },
      { text: 'About −30.5 kilojoules per mole, since that is what the hydrolysis of ATP releases.',
      ...
      { text: 'It cannot be worked out from these figures; you would also need the enthalpy change.',
...

  {
    ...
    options: [
      { text: 'The whole pool turns over roughly 1400 times a day — about once a minute, and far faster in a working muscle. ATP is change in the pocket, not money in the bank.', correct: true },
      { text: 'The body makes 85 kilograms of ATP a day and stores most of it as fat.',
      ...
      { text: 'Most of the 85 kilograms is recycled without being spent, so the true consumption is much lower.',
      ...
      { text: 'The 60 grams is roughly a day\'s supply, held ready.',
        why: 'Out by a factor of about 1400, and it is the error the word "store" causes. At 50 kilojoules a mole, 60 grams is a little over 5 kilojoules, against 8400 a day: a minute\'s worth, not a day\'s.' },
    ],
    explain: 'The arithmetic: 25 litres of cell water at 5 millimoles per litre is about an eighth of a mole; a mole of ATP weighs 507 grams, so the whole body\'s stock is around 60 grams. The 8400 kilojoules a day at 50 kilojoules a mole is about 170 moles, some 85 kilograms — more than its owner weighs. Treat those as orders of magnitude rather than measurements; the shape of the answer is not in doubt.',
  },
  {
    ...
    options: [
      { text: 'A cell holds about a minute\'s worth of ATP and no reserve to fall back on. What it stores energy as is fuel — glycogen and fat — and gradients, which are weeks\' worth; ATP is only what it converts those into at the moment of spending.', correct: true },
      { text: 'Cyanide destroys the ATP that is already present, which is why the effect is so fast.',
      ...
      { text: 'A cell\'s ATP store would last for hours, and cyanide kills by some faster route of its own.',
      ...
      { text: 'It kills because the fuel that can no longer be oxidised builds up and poisons the cell.',
  ...
  },
  {
    ...
    rubric: [
      ...
      'against that, 8400 kilojoules a day at about 50 kilojoules a mole is roughly 170 moles, some 85 kilograms made and spent in a day',
      'so the pool turns over about 1400 times a day: once a minute, and much faster in a working muscle',
  ...
  },
  {
    ...
    options: [
      { text: 'Coupled through a shared chemical intermediate, the two free energy changes add to −12 and the pair runs. Uncoupled, the same ATP is hydrolysed and the reaction does not move at all.', correct: true },
      { text: 'It cannot be made to run, because a reaction with a positive ΔG does not go.',
      ...
      { text: 'Two ATP are needed, since 38 is more than the 30.5 a mole of ATP releases.',
  ...
  },
  {
    ...
    options: [
      { text: 'Acetyl phosphate: it is the product of the first step and the reactant of the second, which is what makes the two steps one reaction whose free energy changes add.', correct: true },
      { text: 'ATP, because it is what supplies the free energy for the whole thing.',
      ...
      { text: 'ADP, because it is produced and then used again to make more ATP.',
      ...
      { text: 'Acetyl-CoA, because it is what the whole pathway is for.',
  ...
  },
  {
    ...
    options: [
      { text: 'The phosphorylated pump is the shared intermediate. The pump is not a machine that uses energy from ATP; it is a machine that is part of the ATP\'s own reaction.', correct: true },
      { text: 'The ATP hydrolyses and releases energy, which the pump collects and uses to change shape.',
      ...
      { text: 'The phosphate is a signal telling the pump when to move, and the energy comes from somewhere else.',
      ...
      { text: 'The pump is a catalyst for ATP hydrolysis, and the transport happens as a side effect.',
  ...
  },
  {
    ...
    options: [
      { text: 'The potassium is moving inwards and the inside is about 70 millivolts negative, so the voltage pays back about three-quarters of what the concentration gradient charges.', correct: true },
      { text: 'Potassium\'s gradient is shallower than sodium\'s, so less work is needed against it.',
      ...
      { text: 'Only two ions move instead of three, and two-thirds of 39.6 is about 26 — the rest is rounding.',
      ...
      { text: 'Potassium leaks back out through open channels, so the pump does not have to work as hard.',
  ...
  },
  {
    ...
    options: [
      { text: 'Only the molecules far out in the tail of the distribution have enough at the moment of collision, and how far out decides everything: the relationship is exponential, and every 5.9 kilojoules per mole taken off the barrier multiplies the rate by ten.', correct: true },
      { text: 'No molecule can ever get over, since 2.6 is so much less than 68.',
      ...
      { text: '68 kilojoules per mole would have to be supplied from outside before the reaction could start.',
      ...
      { text: 'ΔG for the reaction must be at least +68, since that is what it takes to reach the top.',
    ...
    explain: 'The 5.9 is the same number as Section 5.2\'s tenfold concentration ratio, because it is the same RT and the same logarithm. It is worth keeping: it turns "the enzyme speeds this up a hundred million million million times" into "the enzyme took about a hundred kilojoules off the barrier", which is a quantity you can reason about.',
  },
  {
    ...
    rubric: [
      ...
      'so ΔG and the barrier are independent — sugar in air is exergonic by 2870 kilojoules a mole and lasts for years',
    ],
  ...
  },
  {
    ...
    options: [
      { text: 'About 100 kilojoules per mole — seventeen decades at 5.9 each — and it does it by binding the transition state more tightly than it binds the substrate.', correct: true },
      { text: 'About 100 kilojoules per mole, which it supplies to each substrate molecule from the free energy of the reaction.',
      ...
      { text: 'All of it: the enzyme lowers the barrier to zero, which is why the reaction becomes instant.',
      ...
      { text: 'None of it: the enzyme breaks the bonds itself and assembles the product, so there is no barrier left to climb.',
  ...
  },
  {
    ...
    options: [
      { text: 'The transition state is the same arrangement whichever side you climb from, so lowering it lowers the barrier by the same amount from both ends.', correct: true },
      { text: 'Because the enzyme is not used up, so it is available to catalyse both directions equally often.',
      ...
      { text: 'Because ΔG is unchanged, and rates follow ΔG.',
      ...
      { text: 'It does not have to. Many enzymes are directional, which is how a cell drives a pathway one way.',
  ...
  },
  {
    ...
    options: [
      { text: 'The active site is a three-dimensional pocket and the substrate is held by many weak interactions acting at once, so a dozen weak contacts only all fit if the shape is right — and a mirror image cannot be superimposed on the original.', correct: true },
      { text: 'L-glucose has a higher activation energy for the same reaction.',
      ...
      { text: 'The enzyme binds both and only converts D-glucose, because D is the more stable of the two.',
      ...
      { text: 'The site is a rigid pocket cut to the exact shape of D-glucose, so nothing else can enter.',
...

  {
    ...
    explain: 'At 55 °C the enzymes on the bench unfold, which is Section 2.7\'s denaturation, and an unfolded enzyme has no active site: the barrier returns towards its bare 68 and the speed-up collapses from about a thousand to about four. Past roughly 40 °C the proteins of a human cell begin to go, so the range available is a few degrees. Watch what does not change while all this happens — ΔG stays at −12 throughout, because destroying the catalyst cannot alter the two ends any more than adding it could.',
  },
  {
    id: 'i-why-not-heat-2',
    objective: 'why-not-heat',
    ...
    options: [
      { text: 'Two things. Past about 40 °C the cell\'s proteins begin to unfold, so the range available is a few degrees; and heat is indiscriminate — it speeds every other reaction in the cell too, including all the ones that must not happen.', correct: true },
      { text: 'Nothing is wrong in principle: the rate roughly doubles for each 10 °C, and this is how thermophilic bacteria work.',
      ...
      { text: 'It would not work at all, because temperature cannot change the rate of a reaction.',
      ...
      { text: 'It would change ΔG for the step, so the cell would make different products.',
  ...
  },
  {
    ...
    rubric: [
      ...
      'first reason: past about 40 °C the proteins of a human cell begin to unfold — Section 2.7\'s denaturation — so the range available is only a few degrees',
  ...
  },
  {
    ...
    options: [
      { text: 'There is a fixed number of active sites, each busy for a fixed time per molecule converted. Once nearly all of them are occupied nearly all of the time, more substrate has nowhere to go.', correct: true },
      { text: 'The substrate begins to run out at high concentrations.',
      ...
      { text: 'Product builds up at high substrate concentrations and inhibits the enzyme.',
      ...
      { text: 'High substrate concentrations begin to denature the enzyme.',
  ...
  },
  {
    ...
    options: [
      { text: 'It tracks it. The whole working range is below the Michaelis constant, so the enzyme is far from saturated throughout and its rate rises and falls roughly in proportion to how much transmitter is there.', correct: true },
      { text: 'It ignores it. The constant is above the range, which means the enzyme is saturated across the whole range.',
      ...
      { text: 'It tracks it above 200 micromoles per litre and ignores it below.',
      ...
      { text: 'The Michaelis constant says nothing about this without the maximum rate as well.',
    ...
    explain: 'The rule is one comparison: put the Michaelis constant beside the concentration the enzyme actually meets. Well below it, the enzyme is a reporter and its rate tracks its substrate. Well above it, the enzyme is saturated and works flat out regardless. Hexokinase and glucokinase are the same pair of designs as Section 4.5\'s two glucose carriers, for the same reason, and it is not a coincidence: a carrier and an enzyme are the same kind of machine.',
  },
  {
    id: 'i-km-tuning-3',
    objective: 'km-tuning',
  ...
  },
  {
    ...
    options: [
      { text: 'The two sides are different processes. The rise is the exponential of molecules clearing the barrier; the fall is the loss of enzyme as the protein unfolds, and that is fast. The optimum is where the second begins to outrun the first.', correct: true },
      { text: 'It is a bell really, and the optimum is its centre — the sharpness is an artefact of how the axes are drawn.',
      ...
      { text: 'Past the optimum the substrate is being used up faster than it can be replaced, so the measured rate falls.',
      ...
      { text: 'The optimum is the temperature the enzyme evolved to like, and it works worse on either side of it.',
    ...
    explain: 'pH does something related but distinct. The side chains lining an active site must carry the right charge for the chemistry to work, and pH decides whether they do; far from the optimum the protein denatures as well. So the optimum sits where the enzyme works: pepsin near pH 2 in the stomach, a lysosome\'s enzymes near pH 5 — which is why Section 4.6\'s proton pump is in a lysosome\'s membrane at all — and most enzymes of the cytosol near neutral.',
  },
  {
  ...
  },
  {
    ...
    options: [
      { text: 'It is a race for the site. More substrate is needed to get half the sites filled, so the half-way concentration goes up; but with enough substrate every site ends up a substrate\'s, so the ceiling is untouched.', correct: true },
      { text: 'It binds the enzyme permanently and lowers its affinity for the substrate from then on.',
      ...
      { text: 'It lowers the number of working enzyme molecules, and fewer enzymes means a higher Michaelis constant.',
      ...
      { text: 'The ceiling is unchanged because the inhibitor is used up as the reaction proceeds.',
    ...
    explain: 'The diagnostic experiment is a single question: add more substrate and see whether it helps. Only an inhibitor competing for the same site can be outcompeted, so a maximum rate that is eventually reached means competitive, and a maximum rate that falls means the inhibitor is not competing with the substrate for anything.',
  },
  {
  ...
  },
  {
    ...
    options: [
      { text: 'Methanol, which is handled by giving ethanol: the two compete for the same enzyme, so the one present in excess wins the site and the methanol is excreted unchanged.', correct: true },
      { text: 'A nerve agent, which has bonded covalently to the enzyme that clears the transmitter from a synapse.',
      ...
      { text: 'Aspirin taken in excess, which has acetylated the enzyme that makes prostaglandins.',
      ...
      { text: 'A poison that binds away from the active site and bends the enzyme out of shape.',
  ...
  },
  {
    ...
    options: [
      { text: 'Which of the enzyme\'s two shapes they bind to. The protein flickers between an active and an inactive conformation; a molecule that binds preferentially to the active one shifts the balance towards it and is an activator, and one that prefers the inactive shape is an inhibitor.', correct: true },
      { text: 'An inhibitor blocks the active site and an activator opens it.',
      ...
      { text: 'An activator supplies the energy the reaction needs and an inhibitor takes it away.',
      ...
      { text: 'An activator resembles the substrate and an inhibitor does not.',
  ...
  },
  {
    ...
    options: [
      { text: 'Because an S means the change from almost empty to almost full happens over a narrow range, so haemoglobin can be nearly saturated in the lungs and give up most of its oxygen in a working muscle, over a difference in pressure that would barely move a protein without cooperative subunits.', correct: true },
      { text: 'Because four subunits carry four oxygen molecules, so it delivers four times as much per protein.',
      ...
      { text: 'Because the S shape means a higher maximum, so more oxygen is carried at every pressure.',
  ...
  },
  {
    ...
    options: [
      { text: 'Inhibit the last enzyme and the four intermediates before it pile up, each having cost something to make and each now useless; inhibit the first and nothing at all is spent. And "committed" matters because inhibiting an earlier step that fed several pathways would starve all of them at once.', correct: true },
      { text: 'The first enzyme is the slowest step, so controlling it controls the whole rate.',
      ...
      { text: 'The end product can only reach the first enzyme, because the later ones are buried in the pathway.',
      ...
      { text: 'Inhibiting the last step would stop the product forming, which comes to the same thing.',
  ...
  },
  {
    ...
    options: [
      { text: 'Because a switch that can only be thrown once is not a switch. The phosphate does not come off on its own at any useful rate, so without a phosphatase the protein would stay in whichever state it was first put and could never be reset.', correct: true },
      { text: 'To recover the phosphate group, which would otherwise be lost to the cell.',
      ...
      { text: 'To stop the kinase from phosphorylating the same protein over and over and using up the cell\'s ATP.',
      ...
      { text: 'The phosphate falls off by itself anyway, and the phosphatase only speeds that up.',
    ...
    explain: 'Covalent modification is the second of the four control mechanisms and works on a timescale of seconds to minutes, against allostery\'s instant. Attaching a bulky group with two negative charges reshapes the protein around it, so the same trick that pays for transport in Section 5.4 here carries information instead.',
  },
  {
  ...
  },
  {
    ...
    options: [
      { text: 'Nothing is written down anywhere: the set point simply is how tightly the allosteric site holds its ligand. An enzyme that binds isoleucine more tightly settles at a lower concentration of it.', correct: true },
      { text: 'The concentration of threonine, the starting material, which fixes how much isoleucine can be made.',
      ...
      { text: 'The first enzyme\'s Michaelis constant for threonine.',
      ...
      { text: 'A gene whose sequence records the concentration the cell is aiming at.',
  ...
  },
  {
    ...
    options: [
      { text: 'A step that runs strongly downhill one way runs strongly uphill the other, and both routes have to be downhill to work — so at least one step of each must differ and use its own enzyme.', correct: true },
      { text: 'Enzymes work in one direction only, so a separate enzyme is needed for the reverse.',
      ...
      { text: 'Running both routes at once would waste ATP, so the cell keeps them apart.',
      ...
      { text: 'The anabolic route is the catabolic one run backwards, only more slowly because it is uphill.',
  ...
  },
  {
    ...
    objective: 'redox-basics',
    kind: 'mcq',
    question: 'In one step of a working muscle\'s chemistry, lactate loses two hydrogen atoms and NAD<sup>+</sup> becomes NADH. What has been oxidised and what reduced?',
    options: [
      { text: 'Lactate has been oxidised, since losing hydrogen atoms means losing the electrons that came with them; NAD<sup>+</sup> has been reduced, since it gained them.', correct: true },
      { text: 'Lactate has been reduced, since it lost something, and reduction means a loss.',
      ...
      { text: 'Both have been oxidised: hydrogen has left the lactate and hydrogen is what NADH has taken on.',
      ...
      { text: 'Neither, since no oxygen takes part in this reaction.',
    ...
    explain: 'In biology the electrons usually travel as part of hydrogen atoms — an electron and a proton together — so a molecule that loses hydrogen has been oxidised and one that gains hydrogen has been reduced. That is a useful rule of thumb for reading any equation in the next two chapters, where almost every step is written that way.',
  },
  {
    id: 'i-redox-basics-3',
    objective: 'redox-basics',
...

  {
    ...
    options: [
      { text: 'Oxygen pulls harder on shared electrons than carbon or hydrogen do. An electron shared between carbon and hydrogen is held loosely and the same electron on oxygen is held tightly, and the energy released is the difference.', correct: true },
      { text: 'Oxygen is a gas, and reactions that consume a gas release energy.',
      ...
      { text: 'The electron accelerates as it falls, and the kinetic energy it picks up is what is released.',
      ...
      { text: 'Oxygen breaks the bonds in the fuel, and breaking bonds releases energy.',
  ...
  },
  {
    ...
    options: [
      { text: 'Ethanol, because more of its carbons\' bonds are to hydrogen and fewer to oxygen, so its electrons have further to fall before they reach oxygen.', correct: true },
      { text: 'Acetic acid, because it already contains more oxygen and oxygen is what supplies the energy.',
      ...
      { text: 'They yield the same, since both end as carbon dioxide and water and the products are what matter.',
      ...
      { text: 'Acetic acid, because it is an acid and acids are more reactive.',
  ...
  },
  {
    ...
    rubric: [
      ...
      'hence about 37 kilojoules a gram against about 17 — the claim Section 2.6 made and could not then justify',
    ],
...

  {
    ...
    kind: 'task',
    figure: 'fig-metabolism',
    goal: 'Press Electrons, then press In stages to take the same fall in parcels the size of one ATP instead of all at once. Compare the Captured fraction with what it read under One drop, and check that the whole fall has not changed.',
  ...
  },
  {
    ...
    options: [
      { text: 'Oxidation stops. There is nothing left to take electrons off the fuel onto, so catabolism halts above that point until something spends the NADH.', correct: true },
      { text: 'The cell makes more NAD<sup>+</sup> to meet the demand.',
      ...
      { text: 'The NADH accumulates as a store of energy for later, which is what a carrier is for.',
      ...
      { text: 'The electrons pass straight to oxygen without a carrier, so nothing stops.',
  ...
  },
  {
    ...
    rubric: [
      ...
      'burning glucose releases ΔG°′ = −2870 kilojoules per mole in one go, as heat, and Section 5.1 explains why a cell could not use a joule of it',
      ...
      'release 2870 at once and none of it is caught; release it in parcels of thirty or fifty and most of it can be, which is why metabolism is long',
    ],
  ...
  },
  {
    ...
    options: [
      { text: 'Galactose 1-phosphate accumulates and glucose 1-phosphate from this route disappears; the treatment is a diet low in galactose, which is the substrate feeding the block.', correct: true },
      { text: 'Glucose 1-phosphate accumulates, because the reaction cannot go forward and so the product builds up.',
      ...
      { text: 'Everything on both sides of the missing step accumulates, since the pathway has stopped.',
  ...
  },
  {
    ...
    options: [
      { text: 'It runs only because it is coupled. The phosphorylated A is the shared intermediate, which is what makes the ATP\'s free energy change and the reaction\'s add.', correct: true },
      { text: 'It is exergonic and waiting on an enzyme, and the ATP is what activates the enzyme.',
      ...
      { text: 'It runs by itself, and the ATP requirement is a coincidence of how the extract was prepared.',
      ...
      { text: 'It has reached equilibrium, which is why it stops when the ATP runs out.',
