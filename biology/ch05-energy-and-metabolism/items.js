...
export const ITEMS = [
...

  {
    ...
    explain: 'At 55 °C the enzymes on the bench unfold, which is Section 2.7\'s denaturation, and an unfolded enzyme has no active site: the barrier returns towards its bare 68 and the speed-up collapses from about a thousand to about four. A living body has far less room than the bench: Section 2.7 found the least stable proteins of liver and muscle beginning to come apart at, or barely above, body temperature, so the range available is a few degrees. Watch what does not change while all this happens — ΔG stays at −12 throughout, because destroying the catalyst cannot alter the two ends any more than adding it could.',
  },
  {
    id: 'i-why-not-heat-2',
    objective: 'why-not-heat',
  ...
  },
  {
    ...
    rubric: [
      ...
      'hence about 37 kilojoules a gram against about 17, which is the further to fall that Section 2.6 named before it could explain',
    ],
