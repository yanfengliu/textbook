...
export const GLOSSARY = {
  ...
  osmosis: { term: 'Osmosis', def: 'The net movement of water across a selectively permeable membrane, from where water potential is higher to where it is lower. Nothing attracts the water: water mixed with a solute can be arranged in far more ways than water and solute kept apart, and the flow goes on until pressure on the solution side balances that gain.' },
