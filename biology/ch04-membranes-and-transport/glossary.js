...
export const GLOSSARY = {
  ...
  osmosis: { term: 'Osmosis', def: 'The diffusion of water across a selectively permeable membrane, from where water potential is higher to where it is lower. Nothing pulls the water; there are simply more free water molecules on one side than the other.' },
  'water-potential': { term: 'Water potential (Ψ)', def: 'The tendency of water to leave a place, in megapascals, written as the solute potential plus the pressure potential. Pure water at atmospheric pressure is zero, and water always moves from higher water potential to lower.' },
  'solute-potential': { term: 'Solute potential (Ψ<sub>s</sub>)', def: 'The part of water potential contributed by dissolved substances. It is always negative, and roughly proportional to the number of dissolved particles — so a salt, which dissociates, lowers it about twice as much as a sugar at the same molarity.' },
  'pressure-potential': { term: 'Pressure potential (Ψ<sub>p</sub>)', def: 'The part of water potential contributed by physical pressure. It is positive in a cell being squeezed by its own wall, zero in a flaccid cell, and negative in water under tension, as in the xylem of a tree.' },
  ...
  atp: { term: 'ATP', def: 'The molecule a cell spends when it pays for something. Splitting off one of its phosphate groups releases energy that a protein can be built to use, and a pump uses it by attaching that phosphate to itself. Chapter 5 gives the chemistry and says where ATP comes from.' },
