...
export const GLOSSARY = {
  ...
  'cell-wall': { term: 'Cell wall', def: 'A stiff layer outside the plasma membrane that resists the pressure of water entering by osmosis. It is peptidoglycan in bacteria, cellulose in plants, chitin in fungi, and protein or other polymers in archaea.' },
  ...
  'signal-peptide': { term: 'Signal peptide', def: 'A short, mostly water-hating stretch at the start of a newly made protein that marks it for the endoplasmic reticulum. A cytosolic particle recognises it, pauses translation and docks the ribosome on the ER membrane; an enzyme then clips it off.' },
  ...
  cellulose: { term: 'Cellulose', def: 'The long unbranched chain of glucose that makes the fibres of a plant cell wall. The chains bundle into microfibrils of great tensile strength, laid down by enzyme complexes in the plasma membrane.' },
