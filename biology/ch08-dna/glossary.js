...
export const GLOSSARY = {
  ...
  'x-ray-diffraction': { term: 'X-ray diffraction', def: 'The scattering of X-rays by a structure that repeats regularly, into a pattern of spots and arcs whose positions give the spacings of the repeats: the wider a spacing, the nearer the centre its spots fall. No lens can gather scattered X-rays back into an image of anything as small as an atom, so the result is a pattern to be measured and interpreted, not a picture.' },
  ...
  tautomer: { term: 'Tautomer', def: 'One of two forms of a molecule that differ only in where one hydrogen atom sits and that turn into each other readily: a mobile kind of structural isomer. Each base of DNA spends almost all its time in one form, and only in that form do the pairs fit; in the other form a base can pair with the wrong partner.' },
  ...
  'strand-ends': { term: '5′ and 3′ ends', def: 'The two chemically different ends of a strand of nucleic acid, named after carbons of the sugar: the 5′ end\'s last sugar carries a phosphate on its fifth carbon, and the 3′ end\'s a hydroxyl group on its third. A DNA polymerase can add a nucleotide only at a 3′ end.' },
  ...
  'semiconservative-replication': { term: 'Semiconservative replication', def: 'Copying in which the two strands of the parent helix separate and each serves as a template, so that each new double helix is one old strand and one new. Meselson and Stahl showed in 1957, in work published the next year, that DNA is copied this way.' },
  ...
  'reverse-transcriptase': { term: 'Reverse transcriptase', def: 'An enzyme that makes DNA using RNA as its template, the reverse of the usual direction of copying. Telomerase contains one, HIV carries one, and LINE-1, the retrotransposon that makes up about a sixth of the human genome, encodes one, which Alu borrows.' },
