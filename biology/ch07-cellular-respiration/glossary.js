...
export const GLOSSARY = {
  ...
  ubiquinone: { term: 'Ubiquinone', def: 'A small lipid-soluble carrier, also called coenzyme Q, that shuttles electrons within the inner membrane rather than along it. Its long hydrocarbon tail keeps it in the bilayer, which is how complexes with no direct electron path between them exchange electrons.' },
