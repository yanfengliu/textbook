...
export const GLOSSARY = {
  ...
  'excited-state': { term: 'Excited state', def: 'A molecule with one of its electrons in a higher orbital, put there by an absorbed photon. It lasts a few billionths of a second, it holds the photon\'s whole energy, and it gives that electron away far more readily than the unexcited molecule would.' },
