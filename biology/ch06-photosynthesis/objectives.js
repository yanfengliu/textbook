...
//   `bond-strengths`  — §6.1 measures a photon against the 2.6 kJ/mol of thermal jostling and the
...
//   `ph-scale`        — §6.5's gradient is three pH units, and a reader who reads that as "three times"
//                       rather than "a thousandfold" gets the energy wrong by two and a half orders
...
export const OBJECTIVES = [
  // ---- 6.1 Everything here is running on sunlight ----
  {
    ...
    teaches: { sections: ['sunlight'], figures: ['fig-photon'] },
    level: 'apply',
  },
  {
    id: 'light-not-heat',
  ...
  // ---- 6.2 A compartment inside a compartment ----
  {
    ...
    teaches: { sections: ['chloroplast'], figures: ['fig-chloroplast'] },
    level: 'recall',
  },
  {
  ...
  },
  {
    ...
    prereqs: ['division-of-labour', 'flux-factors', 'diffusion-time'],
    teaches: { sections: ['chloroplast'], figures: ['fig-chloroplast'] },
    level: 'explain',
  },
  ...
  {
    id: 'cyclic-flow',
    statement: 'Say what cyclic electron flow around photosystem I produces and what it does not produce, and name the two things it therefore cannot be used for.',
  ...
  // ---- 6.5 Chapter 4's battery, charged by light ----
  {
    ...
    teaches: { sections: ['chemiosmosis'], figures: ['fig-protons'] },
    level: 'explain',
  },
  {
  ...
  // ---- 6.8 Two answers to the same problem ----
  {
    ...
    teaches: { sections: ['c4cam'], figures: ['fig-c4cam'] },
    level: 'explain',
  },
  {
    id: 'c4-mechanism',
