...
export const LEXICON = {
  '初': {
    ...
    uses: [
      ...
      { id: 'chu1-first-time', gloss: '开始；首次', note: '「初命」谓初次以天子之命任命晋大夫为诸侯，是这一卷的起笔。',
        examples: [{ text: '初，智宣子將以瑤為後。', at: '周紀一' }] },
    ],
  },
  '命': {
    ...
    uses: [
      ...
      { id: 'ming4-mandate', gloss: '天命；气运。', note: '名词。「天命之」是上天授命，「智氏之命」是气数。',
        examples: [{ text: '人歸之，天命之', at: '周紀一' }, { text: '智氏之命必不長矣', at: '周紀一' }] },
      { id: 'ming4-decree', gloss: '诏命；册命。', note: '名词，指天子所下的册命。',
        examples: [{ text: '是受天子之命而為諸侯也', at: '周紀一' }] },
    ],
  },
  '晉': {
    ...
    uses: [
      ...
      { id: 'jin4-san-jin', gloss: '「三晋」，指由晋国分出的赵、魏、韩三家', note: '胡三省注：三家分晋国，当时因称之为三晋，犹如后来的三秦、三齐。',
        examples: [{ text: '故三晉之列於諸侯', at: '周紀一' }, { text: '雖以晉、楚、齊、秦之強', at: '周紀一' }] },
    ],
  },
  '大': {
    pinyin: 'dà',
  ...
  '夫': {
    ...
    uses: [
      { id: 'fu1-dafu', gloss: '与「大」合成「大夫」，官名。', note: '读 fū。本卷的「大夫」指晋国掌政的卿大夫之家。',
        reading: 'fū',
        examples: [{ text: '公、侯、卿、大夫是也。', at: '周紀一' }] },
      { id: 'fu2-initial', gloss: '句首语气词，表示要发议论。', note: '读 fú，胡注「夫以，音扶」。本卷作发语词的最多；「丈夫」义本卷未见。',
        reading: 'fú',
  ...
  '斯': {
    ...
    uses: [
      ...
      { id: 'si1-this', gloss: '此；这里。', note: '代词，用在介词之后，指「这个时候」。',
  ...
  '為': {
    ...
    uses: [
      ...
      { id: 'wei4-for', gloss: '替；给。', note: '读 wèi。「为之报仇」即替他报仇。',
        reading: 'wèi',
  ...
  '諸': {
    ...
    uses: [
      ...
      { id: 'zhu1-zhiyu', gloss: '「之于」的合音，等于「之于」。', note: '「出诸袖中」即「出之于袖中」。胡注引毛晃曰：奏，进上也。',
  ...
  '子': {
    ...
    uses: [
      ...
      { id: 'zi3-you', gloss: '对人的尊称，等于「您」。', note: '对话中称对方为「子」。',
  ...
  '之': {
    ...
    uses: [
      ...
      { id: 'zhi1-pronoun', gloss: '他；它，作宾语。', note: '第三人称代词，指上文已出现的人或事。',
  ...
  '莫': {
    ...
    uses: [
      ...
      { id: 'mo4-not', gloss: '不。', note: '副词，用在动词之前表示否定。',
  ...
  '分': {
    ...
    uses: [
      ...
      { id: 'fen1-divide', gloss: '分割；瓜分。', note: '读 fēn。指瓜分晋国的土地。',
        reading: 'fēn',
  ...
  '眾': {
    ...
    uses: [
      ...
      { id: 'zhong4-people', gloss: '众人；一般人', note: '此为名词用法，与「圣人」相对。',
        examples: [{ text: '眾人之識近，故必待其著而後救之', at: '周紀一' }] },
      { id: 'zhong4-troops', gloss: '部众；兵众', note: '此义指军队，见晋阳之战。',
  ...
  '高': {
    ...
    uses: [
      ...
      { id: 'gao1-surpass', gloss: '高出；超过。', note: '「高世之智」谓高出当世的智慧。',
        examples: [{ text: '雖有絕倫之力，高世之智', at: '周紀一' }] },
    ],
  },
  '世': {
  ...
  '智': {
    ...
    uses: [
      ...
      { id: 'zhi4-wisdom', gloss: '智慧；智谋。', note: '与「力」并举，如「智力」「智不能周」。',
  ...
  '敢': {
    ...
    uses: [
      ...
      { id: 'gan3-resolute', gloss: '与「果」合成「果敢」，果断勇敢。', note: '这是形容词性的复合词，与「敢于」的助动词用法不同。',
  ...
  '而': {
    ...
    uses: [
      ...
      { id: 'er2-you', gloss: '代词：你；你的。', note: '旧注以「而」为第二人称代词，等于「汝」。此句是赵简子嘱咐无恤。',
  ...
  '非': {
    ...
    uses: [
      ...
      { id: 'fei1-without', gloss: '无；若无', note: '用于假设性的没有：「非名不著」谓没有名就不能显现。',
  ...
  '故': {
    ...
    uses: [
      ...
      { id: 'gu4-reason', gloss: '缘故；原因', note: '此为名词用法，句末的「故也」就是解释原因的判断。',
  ...
  '治': {
    ...
    uses: [
      ...
      { id: 'zhi4-peace', gloss: '安定；太平。', note: '胡注：「治，直吏翻。」即今 zhì；「治安」谓上下相保而国家安定。',
        reading: 'zhì',
  ...
  '庶': {
    ...
    pos: '形',
    uses: [
      { id: 'shu4-commoner', gloss: '平民；百姓', note: '「庶人」为名词性成分，取其众多之义，指平民百姓；「士庶人」谓士与庶人。胡注：「治，直之翻。」',
        examples: [{ text: '卿大夫治士庶人', at: '周紀一' }] },
  ...
  '貴': {
    ...
    uses: [
      ...
      { id: 'gui4-nobles', gloss: '指尊贵的人；尊卑的等级。', note: '「辨贵贱」的「贵贱」是名词性的，指尊卑的等级。',
  ...
  '使': {
    ...
    uses: [
      ...
      { id: 'shi4-messenger', gloss: '使者。', note: '读 shì。「使使者」前一字是动词「派遣」（读 shǐ），后一字是名词「使者」，与「出使」同读 shì。',
        reading: 'shì',
  ...
  '猶': {
    ...
    pos: '副',
    uses: [
      { id: 'you2-like', gloss: '如同；好像', note: '表比喻，以彼喻此。全卷四见，此举两处。',
  ...
  '足': {
    ...
    uses: [
      ...
      { id: 'zu2-sufficient', gloss: '足够；足以。', note: '「足以」「不足」皆此义，表力量或德行够得上。',
        examples: [{ text: '其勢皆足以逐君而自為', at: '周紀一' }, { text: '豈其力不足而心不忍哉', at: '周紀一' }] },
      { id: 'zu2-worth', gloss: '值得；够得上（多用于反问）。', note: '「又何失人之足患哉」谓又何须忧虑失去人才。',
  ...
  '事': {
    ...
    uses: [
      ...
      { id: 'shi4-serve', gloss: '侍奉；事奉', note: '此为动词用法，「事上」即侍奉上位者。',
  ...
  '衛': {
    ...
    uses: [
      ...
      { id: 'wei4-state', gloss: '国名，卫国。', note: '周初所封的诸侯国，在今河南一带；仲叔于奚、孔子都与卫有关。',
  ...
  '然': {
    ...
    uses: [
      ...
      { id: 'ran2-suffix', gloss: '形容词词尾，表状态。', note: '「粲然」即鲜明整齐的样子；本卷此类用法仅一见。',
  ...
  '相': {
    ...
    uses: [
      ...
      { id: 'xiang4-minister', gloss: '辅佐之臣；国相', note: '读去声，名词用法，指辅相、执政之臣。胡注：「相，息酱翻。」',
        reading: 'xiàng',
  ...
  '安': {
    ...
    uses: [
      { id: 'an1-stable', gloss: '安定；太平。', note: '「国家治安」谓国家安定太平。',
        examples: [{ text: '然後能上下相保而國家治安', at: '周紀一' }] },
      { id: 'an1-how', gloss: '怎么；哪里。', note: '疑问副词，用于反问。「礼安得独在哉」谓礼怎能独自存在。',
        examples: [{ text: '則禮安得獨在哉', at: '周紀一' }] },
      { id: 'an1-yi', gloss: '安邑，魏氏的都邑。', note: '与下文「平阳」并提，都是引水灌城的去处。',
  ...
  '文': {
    ...
    uses: [
      ...
      { id: 'wen2-title', gloss: '谥号用字。文侯，即魏斯。', note: '魏斯为魏氏宗主，受封为诸侯。',
        examples: [{ text: '魏斯者，桓子之孫也，是為文侯。', at: '周紀一' }] },
      { id: 'wen2-adorn', gloss: '文饰；文采。', note: '「巧文辩慧」谓善于文饰、能言善辩。本卷未见「文章」「文字」义。',
  ...
  '易': {
    ...
    uses: [
      ...
      { id: 'yi4-change', gloss: '改变；变易', note: '「不可易」谓不可颠倒改易，此处就君臣之位而言。',
        examples: [{ text: '猶天地之不可易也', at: '周紀一' }] },
      { id: 'yi4-book', gloss: '《易》，书名，五经之一', note: '专名用法。本卷两见，一为「文王序《易》」，一为引《易》之辞。',
  ...
  '尊': {
    ...
    uses: [
      ...
      { id: 'zun1-high', gloss: '高（与「卑」相对）。', note: '这一义是形容词，用于天与地的对比。',
  ...
  '言': {
    ...
    uses: [
      ...
      { id: 'yan2-words', gloss: '话；言语（名词）。', note: '「絺疵之言」「臣之言」皆指所说的话。',
  ...
  '抑': {
    ...
    uses: [
      ...
      { id: 'yi4-or', gloss: '或者；还是。', note: '连词，表选择，「抑为保障乎」即还是作保障呢。',
        examples: [{ text: '以為繭絲乎？抑為保障乎', at: '周紀一' }] },
    ],
  },
  '周': {
    ...
    uses: [
      ...
      { id: 'zhou1-complete', gloss: '周全；完备', note: '此义为动词，「智不能周」谓智虑不能周全；本卷只此一见。',
  ...
  '微': {
    ...
    uses: [
      ...
      { id: 'wei1-weizi', gloss: '微子，商纣王的庶兄。', note: '胡注引《史记》述帝乙欲立微子启而太史争之之事。',
  ...
  '暴': {
    ...
    uses: [
      ...
      { id: 'bao4-outrage', gloss: '欺凌；轻蔑。', note: '「暴蔑其君」即欺凌轻蔑其君。',
  ...
  '已': {
    ...
    pos: '副',
    uses: [
      { id: 'yi3-eryi', gloss: '与「而」合成「而已」，表限止：罢了。', note: '句末「而已矣」是两层语气叠用。',
        examples: [{ text: '當守節伏死而已矣', at: '周紀一' }] },
  ...
  '代': {
    ...
    uses: [
      ...
      { id: 'dai4-place', gloss: '地名。代，战国时国名，在今河北蔚县一带', note: '赵襄子灭代而有其地，故封伯鲁之子于此，号代成君。胡注：「代国在夏屋句注之北，赵襄子灭之。」',
  ...
  '成': {
    ...
    uses: [
      ...
      { id: 'cheng2-tang', gloss: '成汤，商朝开国之君', note: '此为专名用字；同卷的「代成君」也是称号。',
  ...
  '亂': {
    ...
    uses: [
      ...
      { id: 'luan4-rebellious', gloss: '形，叛乱的；作乱的。', note: '「乱臣」与「败子」对举。',
  ...
  '親': {
    ...
    uses: [
      ...
      { id: 'qin1-kin', gloss: '亲属；亲疏的亲。', note: '「序亲疏」指排定亲疏的次序。',
        examples: [{ text: '夫禮，辨貴賤，序親疏', at: '周紀一' }] },
    ],
  },
  '疏': {
    ...
    uses: [
      { id: 'shu1-distant', gloss: '关系远的；不亲近', note: '「序亲疏」谓排列亲疏的次序。',
        examples: [{ text: '夫禮，辨貴賤，序親疏', at: '周紀一' }] },
      { id: 'shu1-alienate', gloss: '疏远；被疏远', note: '此为动词用法，「严者易疏」谓威严的人容易被人疏远。',
        examples: [{ text: '愛者易親，嚴者易疏', at: '周紀一' }] },
    ],
    variants: ['踈'],
  },
  ...
  '著': {
    ...
    uses: [
      ...
      { id: 'zhu4-evident', gloss: '显著；明显（与「微」相对）。', note: '本卷用它讲事变由微到著的道理，「救其著」即事已显著才去挽救。',
  ...
  '叔': {
    ...
    uses: [
      ...
      { id: 'shu1-name', gloss: '人名用字：仲叔于奚。', note: '卫国大夫仲叔于奚，因救孙桓子有功。',
  ...
  '辭': {
    ...
    uses: [
      ...
      { id: 'ci2-decline', gloss: '推辞；辞让。', note: '仲叔于奚辞去城邑而请求繁缨。',
  ...
  '多': {
    ...
    uses: [
      ...
      { id: 'duo1-give-more', gloss: '多加，多给。', note: '「不如多与之邑」谓不如多给他城邑。',
        examples: [{ text: '孔子以為不如多與之邑', at: '周紀一' }] },
      { id: 'duo1-often', gloss: '大多；往往。', note: '副词用法。',
  ...
  '與': {
    ...
    uses: [
      ...
      { id: 'yu3-with', gloss: '跟；同（介词，引出动作的对象）。', note: '「与韩康子、魏桓子宴于蓝台」「阴与张孟谈约」皆此用法。',
        examples: [{ text: '與韓康子、魏桓子宴於藍臺', at: '周紀一' }, { text: '二子乃陰與張孟談約', at: '周紀一' }] },
      { id: 'yu3-give', gloss: '给；给予。', note: '「多与之邑」「弗与」「必姑与之」皆此义。',
        examples: [{ text: '孔子以為不如多與之邑', at: '周紀一' }, { text: '將欲取之，必姑與之', at: '周紀一' }] },
      { id: 'yu3-follow', gloss: '亲附；拥护。', note: '「其谁与我」即谁会亲附我、为我所用。',
  ...
  '政': {
    ...
    uses: [
      ...
      { id: 'zheng4-rule', gloss: '执政；主持政事', note: '此为动词用法，「为政」「擅政」都是。',
  ...
  '欲': {
    ...
    uses: [
      ...
      { id: 'yu4-desire', gloss: '所想要的；欲望（名词性结构）。', note: '「子乃为所欲为」中「所欲」指想做的事。',
  ...
  '先': {
    ...
    uses: [
      ...
      { id: 'xian1-put-first', gloss: '把……放在前头；先做。', note: '胡注：「先，悉荐翻。」古去声一读 xiàn；今普通话仍读 xiān。本卷「知所先后」的「先」胡注也读去声。',
        reading: 'xiàn',
        examples: [{ text: '正名，細務也，而孔子先之', at: '周紀一' }] },
      { id: 'xian1-late', gloss: '已故的；上代的。', note: '读 xiān（如字）。「先王」指已故的周天子；「先主」是家臣对已故主君的称呼，胡注：「死则曰先主。」',
        reading: 'xiān',
  ...
  '正': {
    ...
    uses: [
      ...
      { id: 'zheng4-proper', gloss: '形，正当；端正。', note: '「名不正」即名分不正当。',
        examples: [{ text: '以為名不正則民無所措手足', at: '周紀一' }] },
      { id: 'zheng4-upright', gloss: '形，正直。', note: '「正直中和」是司马光给「德」下的定义。',
  ...
  '無': {
    ...
    uses: [
      ...
      { id: 'wu2-do-not', gloss: '不要；通「毋」', note: '表禁止：「无以尹铎为少」谓不要因为尹铎是小臣而轻视他。',
  ...
  '生': {
    ...
    uses: [
      ...
      { id: 'sheng1-arise', gloss: '产生；发生。', note: '「生于微」即从细微处发生。',
        examples: [{ text: '夫事未有不生於微而成於著。', at: '周紀一' }] },
      { id: 'sheng1-people', gloss: '「生民」指百姓、人民。', note: '「生民之类糜灭几尽」谓百姓几乎死绝。',
  ...
  '其': {
    ...
    uses: [
      ...
      { id: 'qi2-rhetorical', gloss: '表反诘，犹「岂」、「难道」', note: '此为语气副词用法，本卷两见。',
  ...
  '識': {
    ...
    uses: [
      ...
      { id: 'shi2-insight', gloss: '见识；认识。', note: '「众人之识近」即众人的见识短浅。',
        reading: 'shí',
        examples: [{ text: '眾人之識近，故必待其著而後救之。', at: '周紀一' }] },
  ...
  '近': {
    ...
    uses: [
      ...
      { id: 'jin4-shortsighted', gloss: '浅近；眼前。', note: '「众人之识近」谓众人的见识短浅，与「圣人之虑远」相对。',
        examples: [{ text: '眾人之識近，故必待其著而後救之', at: '周紀一' }] },
      { id: 'jin4-close', gloss: '亲近；宠幸。', note: '「近幸」即亲近宠幸。',
  ...
  '及': {
    ...
    uses: [
      ...
      { id: 'ji2-when', gloss: '等到；到了', note: '「及智宣子卒」是时间从句的起头。',
  ...
  '堅': {
    ...
    uses: [
      ...
      { id: 'jian1-solid', gloss: '坚硬之物；指箭矢所射的坚固目标。', note: '「则不能以入坚」谓箭不能射入坚硬之物。',
  ...
  '至': {
    ...
    uses: [
      ...
      { id: 'zhi4-as-for', gloss: '介，至于；说到。', note: '用于另起一端。',
  ...
  '書': {
    ...
    pos: '名',
    uses: [
      { id: 'shu1-write', gloss: '书写；写', note: '动词用法，本卷一见于「书训戒之辞于二简」，谓把训戒之辞写在两片竹简上。胡注引孔颖达：「书者，舒也。」',
        examples: [{ text: '乃書訓戒之辭於二簡', at: '周紀一' }] },
      { id: 'shu1-classic', gloss: '《书》，即《尚书》；亦指其篇目', note: '专名用法，本卷有《书》《夏书》《周书》。',
  ...
  '日': {
    ...
    uses: [
      ...
      { id: 'ri4-daily', gloss: '一天天地；日益。', note: '作状语。',
  ...
  '幾': {
    ...
    uses: [
      { id: 'ji1-nearly', gloss: '几乎；将近。', note: '「糜灭几尽」即几乎灭尽。',
        examples: [{ text: '生民之類糜滅幾盡', at: '周紀一' }] },
      { id: 'ji1-subtle', gloss: '细微；隐微。', note: '「万几」指万事的细微之处，胡三省注以「微」解之。',
  ...
  '德': {
    ...
    uses: [
      ...
      { id: 'de2-favour', gloss: '恩德；德政', note: '「未有代德而有二王」谓没有代周之德却称王。',
        examples: [{ text: '幽、厲失德，周道日衰', at: '周紀一' }, { text: '未有代德而有二王', at: '周紀一' }] },
    ],
    variants: ['徳'],
  },
  '道': {
  ...
  '隧': {
    ...
    uses: [
      ...
      { id: 'sui4-tunnel-verb', gloss: '动，修隧道。', note: '「叔父有地而隧」是说叔父若在自己的土地上自行掘隧道，又何必请示。',
  ...
  '章': {
    ...
    uses: [
      ...
      { id: 'zhang1-name', gloss: '人名用字：任章、启章', note: '任章是魏桓子的相，启章是韩武子。',
  ...
  '惡': {
    ...
    uses: [
      ...
      { id: 'wu4-hate', gloss: '厌恶；不喜欢。', note: '读 wù。胡注：「恶，乌路翻。」「亦叔父之所恶也」谓这也是叔父所厌恶的。',
        reading: 'wù',
  ...
  '數': {
    ...
    uses: [
      ...
      { id: 'shu4-several', gloss: '几；几个', note: '表不定的多数：「数百年」谓几百年。',
  ...
  '強': {
    ...
    uses: [
      ...
      { id: 'qiang2-the-strong', gloss: '名词用法：强者；强敌', note: '「击强」谓攻击强敌，与「入坚」对举。',
  ...
  '自': {
    ...
    uses: [
      ...
      { id: 'zi4-from', gloss: '从；由。', note: '介词，表示时间或处所的起点。',
  ...
  '卒': {
    ...
    uses: [
      ...
      { id: 'zu2-finally', gloss: '终于；到底（副词）。', note: '胡注：「卒，子恤翻，终也。」',
        examples: [{ text: '然而卒不敢者', at: '周紀一' }] },
      { id: 'zu2-soldier', gloss: '士兵。', note: '胡注：「卒，臧没翻。」《说文》：「吏人给事者衣为卒。」',
  ...
  '奸': {
    ...
    uses: [
      ...
      { id: 'jian1-evil', gloss: '奸邪；奸谋。', note: '读 jiān。「遂其奸」指实现他的奸谋。',
        reading: 'jiān',
  ...
  '盡': {
    ...
    uses: [
      { id: 'jin4-exhausted', gloss: '穷尽；完结', note: '「先王之礼于斯尽矣」谓先王的礼制到此完结。',
        examples: [{ text: '先王之禮於斯盡矣。', at: '周紀一' }] },
      { id: 'jin4-all', gloss: '全部；全都；完全', note: '「尽灭」谓全部消灭，「几尽」谓几乎尽绝，「全尽」谓完全具备。胡注：「几，居依翻，又渠希翻，近也。」',
  ...
  '顧': {
    ...
    uses: [
      ...
      { id: 'gu4-on-the-contrary', gloss: '副，反而；却。', note: '「顾不易邪」即岂不更容易吗，是反诘的语气。',
  ...
  '義': {
    ...
    uses: [
      ...
      { id: 'yi4-righteous-man', gloss: '形容词用法：有节义的', note: '「义士」谓有节义之人，是襄子称豫让之语。',
        examples: [{ text: '而此人欲為報仇，真義士也', at: '周紀一' }] },
    ],
  },
  '侵': {
  ...
  '長': {
    ...
    uses: [
      ...
      { id: 'zhang3-superior', gloss: '居首位；争雄长。', note: '读 zhǎng。胡注：「长，知两翻。」「相雄长」指互争雄长。',
        reading: 'zhǎng',
  ...
  '遂': {
    ...
    uses: [
      ...
      { id: 'sui4-accomplish', gloss: '成；达到；逞', note: '此为动词用法，「事未遂」谓事情未成，「遂其奸」谓逞其奸计。',
  ...
  '賢': {
    ...
    uses: [
      ...
      { id: 'xian2-the-wise', gloss: '名词：贤人；有德才的人。', note: '「通谓之贤」即笼统地称他为贤人。',
        examples: [{ text: '而世俗莫之能辨，通謂之賢', at: '周紀一' }, { text: '遂使聖賢之後為諸侯者', at: '周紀一' }] },
      { id: 'xian2-surpass', gloss: '胜过；超过。', note: '「贤于人者五」即超过别人的地方有五处。',
  ...
  '將': {
    ...
    uses: [
      ...
      { id: 'jiang1-want', gloss: '「将欲」：想要。', note: '引《周书》语，「将欲败之」「将欲取之」即想要败坏他、想要夺取他。',
        reading: 'jiāng',
        examples: [{ text: '將欲敗之，必姑輔之', at: '周紀一' }, { text: '將欲取之，必姑與之', at: '周紀一' }] },
      { id: 'jiang4-lead', gloss: '率领。', note: '读 jiàng。「将卒犯其前」即率领士兵冲击敌军前阵。',
        reading: 'jiàng',
        examples: [{ text: '襄子將卒犯其前', at: '周紀一' }] },
    ],
    variants: ['将'],
  ...
  '果': {
    ...
    uses: [
      ...
      { id: 'guo3-bold', gloss: '果敢；果决。', note: '「强毅果敢则贤」谓刚强坚毅、果断勇敢是其一长。',
        examples: [{ text: '強毅果敢則賢', at: '周紀一' }] },
      { id: 'guo3-really', gloss: '果真；当真（副词）。', note: '「若果立瑶也」谓如果真立了瑶。',
        examples: [{ text: '若果立瑤也，智宗必滅', at: '周紀一' }] },
    ],
  },
  '宵': {
  ...
  '若': {
    ...
    uses: [
      { id: 'ruo4-if', gloss: '连，如果。', note: '「若果立瑶也」即如果真的立了瑶。',
        examples: [{ text: '若果立瑤也，智宗必滅', at: '周紀一' }] },
      { id: 'ruo4-not-as-good', gloss: '动，及；比得上，多用于「不若」。', note: '「不若得愚人」即不如得到愚人。',
  ...
  '族': {
    ...
    uses: [
      ...
      { id: 'zu2-branch', gloss: '「别族」，别立一族', note: '「智果别族于太史为辅氏」谓智果向太史登记，别立为辅氏。',
        examples: [{ text: '智果別族於太史為輔氏', at: '周紀一' }] },
    ],
  },
  '史': {
  ...
  '輔': {
    ...
    uses: [
      ...
      { id: 'fu3-clan', gloss: '姓氏用字：辅氏、辅果。', note: '智果谏而不听，别族于太史，为辅氏，故灭族之后独有辅果得存。胡注：以别族也。',
        examples: [{ text: '智果別族於太史為輔氏', at: '周紀一' }] },
    ],
  },
  '簡': {
    ...
    uses: [
      ...
      { id: 'jian3-slip', gloss: '竹简；写字用的竹片。', note: '胡注：「简，竹策也。」赵简子书训戒之辞于二简以授二子。',
  ...
  '中': {
    ...
    uses: [
      ...
      { id: 'zhong1-balanced', gloss: '中正；适中。', note: '「正直中和」谓正直而中正平和。',
        examples: [{ text: '正直中和之謂德', at: '周紀一' }] },
    ],
  },
  '奏': {
  ...
  '宴': {
    ...
    uses: [
      ...
      { id: 'yan4-banquet', gloss: '宴会。', note: '名词，「一宴」指一次宴会。',
        examples: [{ text: '今主一宴而恥人之君相', at: '周紀一' }] },
    ],
  },
  '藍': {
  ...
  '患': {
    ...
    uses: [
      ...
      { id: 'huan4-worry', gloss: '忧虑；担忧。', note: '「何失人之足患哉」即哪里还怕失去人才呢。',
        examples: [{ text: '又何失人之足患哉！', at: '周紀一' }] },
    ],
  },
  '恥': {
  ...
  '害': {
    ...
    uses: [
      ...
      { id: 'hai4-injury', gloss: '祸害；害处。', note: '名词，「其为害」指它造成的祸害。',
  ...
  '利': {
    ...
    uses: [
      ...
      { id: 'li4-sharp', gloss: '锋利。', note: '「天下之利也」谓是天下最锋利的金属。',
        examples: [{ text: '棠溪之金，天下之利也', at: '周紀一' }] },
      { id: 'li4-consider-profitable', gloss: '以……为利；贪图。', note: '「岂不利朝夕分赵氏之田」谓难道不想早晚就瓜分赵氏的田地。',
  ...
  '敗': {
    ...
    uses: [
      ...
      { id: 'bai4-rout', gloss: '动，打败。', note: '「大败智伯之众」即把智伯的军队打得大败。',
        examples: [{ text: '大敗智伯之眾', at: '周紀一' }] },
      { id: 'bai4-degenerate', gloss: '形，败坏的；堕落的。', note: '「败子」与「乱臣」并举，指败家之子。',
        examples: [{ text: '國之亂臣，家之敗子', at: '周紀一' }] },
    ],
  },
  '姑': {
  ...
  '質': {
    ...
    uses: [
      { id: 'zhi4-target', gloss: '质的；箭靶，喻受攻击的对象。', note: '胡注：「质，脂利翻，物相缀当也。……质，谓椹质也，质的也。椹质受斧，质的受矢。」「为智氏质」谓成为智氏加兵的对象。',
        examples: [{ text: '奈何獨以吾為智氏質乎', at: '周紀一' }] },
      { id: 'zhi4-submit', gloss: '委质：委身事人，献身为臣。', note: '「既已委质为臣」谓既已委身做人家的臣子。',
        examples: [{ text: '既已委質為臣，而又求殺之', at: '周紀一' }] },
    ],
  },
  '藺': {
  ...
  '帥': {
    ...
    uses: [
      ...
      { id: 'shuai4-commander', gloss: '统帅；主帅', note: '此为名词用法，「德者，才之帅也」谓德是才的统帅。',
  ...
  '完': {
    ...
    uses: [
      { id: 'wan2-sound', gloss: '完好；坚固', note: '「城厚完」谓城墙厚而完好，是从者劝襄子走长子之语。',
        examples: [{ text: '長子近，且城厚完', at: '周紀一' }] },
      { id: 'wan2-repair', gloss: '修治使完整；修筑', note: '「完之」谓把城修治好。胡注：「罢，读曰疲。」谓民疲力以完城。',
  ...
  '實': {
    ...
    uses: [
      ...
      { id: 'shi2-fill', gloss: '动，使充实；填满。', note: '「以实之」即用搜刮来的财货充实仓库。',
  ...
  '翼': {
    ...
    uses: [
      ...
      { id: 'yi4-flank', gloss: '从两侧夹击，是名词活用为动词。', note: '「韩、魏翼而击之」谓韩、魏从两翼夹击智伯军。',
  ...
  '察': {
    ...
    uses: [
      ...
      { id: 'cha2-observer', gloss: '明察的人；善于审察的人。', note: '「是以察者多蔽于才而遗于德」谓明察之士往往为才所蔽而忽略其德。',
        examples: [{ text: '是以察者多蔽於才而遺於德', at: '周紀一' }] },
    ],
  },
  '直': {
  ...
  '嚴': {
    ...
    uses: [
      ...
      { id: 'yan2-austere', gloss: '令人敬畏的；威严。', note: '「严者」指令人敬畏的人，与「爱者」相对。',
        examples: [{ text: '愛者易親，嚴者易疏', at: '周紀一' }] },
    ],
  },
  '愛': {
