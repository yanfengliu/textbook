...
10. **Publish what is written, and start nothing new.** Chapters 7 and 8 were written before chapter 6 landed. They ship at chapter 6's reduced scope: four figures each, questions instead of figure tasks, point 4's review before they land, and no new gates. No chapter after 8 starts, and other new work waits, until the owner asks.
